...
class Thing(models.Model):
    ...
    color = models.CharField(max_length=50, blank=True, null=True) # 颜色
    caizhi = models.CharField(max_length=50, blank=True, null=True) # 材质
    shiyong = models.CharField(max_length=50, blank=True, null=True) # 适用人群
    pinpai = models.CharField(max_length=50, blank=True, null=True) # 品牌
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
...
class Order(models.Model):
    ...
    gwc = models.CharField(max_length=1000, blank=True, null=True)  # 商品明细
    amount = models.CharField(max_length=100, blank=True, null=True)  # 商品总价
